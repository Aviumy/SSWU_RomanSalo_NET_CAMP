...
ALTER TABLE
    "Предмети груп" ADD CONSTRAINT "Предмети груп_id_групи_primary" PRIMARY KEY("id_групи");
ALTER TABLE
...
CREATE TABLE "Курсові роботи"(
    ...
    "Номер заліковки студента" BIGINT NOT NULL,
...
ALTER TABLE
    "Предмети викладачів" ADD CONSTRAINT "Предмети викладачів_id_предмету_foreign" FOREIGN KEY("id_предмету") REFERENCES "Навчальні предмети"("id_предмету");
ALTER TABLE
    "Студенти" ADD CONSTRAINT "Студенти_id_кафедри_foreign" FOREIGN KEY("id_кафедри") REFERENCES "Кафедри"("id_кафедри");
ALTER TABLE
...
ALTER TABLE
    "Академ"." групи" ADD CONSTRAINT "Академ_ групи_id_факультету_foreign" FOREIGN KEY("id_факультету") REFERENCES "Факультети"("id_факультету");
ALTER TABLE
    "Академ"." групи" ADD CONSTRAINT "Академ_ групи_id_групи_foreign" FOREIGN KEY("id_групи") REFERENCES "Предмети груп"("id_групи");
ALTER TABLE
...
ALTER TABLE
    "Курсові роботи" ADD CONSTRAINT "Курсові роботи_id_факультету_foreign" FOREIGN KEY("id_факультету") REFERENCES "Факультети"("id_факультету");
ALTER TABLE
    "Студенти" ADD CONSTRAINT "Студенти_id_спеціальності_foreign" FOREIGN KEY("id_спеціальності") REFERENCES "Спеціальності"("id_спеціальності");
ALTER TABLE
...
ALTER TABLE
    "Предмети груп" ADD CONSTRAINT "Предмети груп_id_предмету_foreign" FOREIGN KEY("id_предмету") REFERENCES "Навчальні предмети"("id_предмету");
ALTER TABLE
    "Предмети викладачів" ADD CONSTRAINT "Предмети викладачів_id_викладача_foreign" FOREIGN KEY("id_викладача") REFERENCES "Викладачі"("id_викладача");
ALTER TABLE
...
ALTER TABLE
    "Студенти" ADD CONSTRAINT "Студенти_id_факультету_foreign" FOREIGN KEY("id_факультету") REFERENCES "Факультети"("id_факультету");
ALTER TABLE
